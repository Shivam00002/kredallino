  ...
  return (
    ...
    >
      <div className="container w-full mx-auto py-8 md:py-16">
        ...
        <div className="grid w-full grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-6 lg:gap-8 items-center justify-items-center">
          {companies.map((company) => (
            <div
              key={company.id}
              className="w-full max-w-[140px] md:max-w-[120px] lg:max-w-[150px] transition-all duration-300 opacity-75 hover:opacity-100"
            >
              <img
                src={company.logo}
